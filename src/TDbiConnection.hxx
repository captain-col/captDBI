...
#ifndef DBICONNECTION
#define DBICONNECTION
...
/// Add name to list of existing tables (necessary when creating tables)
/// Default name = "", reread all tables from database.
  void SetTableExists(const std::string& tableName = "");

// Idle connnection management
...
/// Connection is permanent, don't close even when idle.
  void SetPermanent(Bool_t permanent = true) { fIsTemporary = ! permanent; }
