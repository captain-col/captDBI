...
class TVldRange : public TObject {
 ...
 public:
   ...
   */
   ...
   TVldTimeStamp GetTimeStart() const { return fTimeStart; }
   TVldTimeStamp GetTimeEnd()   const { return fTimeEnd; }
   ...
   void SetTimeStart(const TVldTimeStamp& tstart) { fTimeStart = tstart; }
   void SetTimeEnd(const TVldTimeStamp& tend) { fTimeEnd = tend; }
