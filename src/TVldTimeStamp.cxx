...
CP::TVldTimeStamp::TVldTimeStamp() : fSec(0), fNanoSec(0) {
    Set();
}
...
void CP::TVldTimeStamp::Add(Double_t seconds) {
    ...
    NormalizeNanoSec();
    if (seconds > 1e6) {
        DbiWarn("VldTimeStamp moved by offset " << seconds <<" which is too large to maintain ns accuracy." << "  ");
    }
}
